 ...
 * @author jocelyn shen
 * @version JDK 11.0.2
 * Command to run: javac --module-path=*filepath* --add-modules=javafx.controls AnimalSanctuary.java 
 * Please ensure you have JavaFX downloaded.
 * javac --module-path=C:\Users\jocel\OneDrive\Documents\openjfx-11.0.2_windows-x64_bin-sdk\javafx-sdk-11.0.2\lib --add-modules=javafx.controls AnimalSanctuary.java
 */
